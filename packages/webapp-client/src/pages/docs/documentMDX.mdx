...
## SetUp
<br />
Setup is quick and easy, taking less than five minutes. First, head to the PodWatch website and create an account. Add a new cluster to your account, and get your cluster ID and secret. If you do not wish to use the PodWatch Web Service, you can skip down to the <span style = {{ color:'lightBlue'}}>[Custom Server](#custom-server)</span> instructions.
<br />
...
## Deployment
<br />
<div id="copycode" style = {{padding: '1rem', backgroundColor:'grey',overflow: "auto", maxWidth: "1380px"}} >
...
<br />
### ClusterRoleBinding
<div id= "ClusterRoleBinding" style = {{padding: '1rem', backgroundColor:'grey',overflow: "auto", maxWidth: "1380px"}}>
...
<div id= "clustomcode" style = {{padding: '1rem', backgroundColor:'grey',overflow: "auto", maxWidth: "1380px"}}>
<br />
...
<br />
<div id= "endpointcode" style = {{padding: '1rem', backgroundColor:'grey',overflow: "auto", maxWidth: "1380px"}}>
```yml
{
